...
public sealed class UpdateProductHandler(IProductCommands productCommands, IProductQuery productQuery) : IRequestHandler<UpdateProductCommand, Result<ProductResponse>>
{
